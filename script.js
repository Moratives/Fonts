      ...
      '<div class="cb-container">' +
        '<div class="cb-row">' +
          '<div class="cb-col-half" style="flex:1.6;">' +
            '<h2 class="cbn-heading cb-heading cb-h2" style="margin-bottom:8px;">Hi! I\'m Theresa,</h2>' +
            '<p class="cbn-subheading cb-subheading" style="margin-bottom:24px;">Career Clarity Expert &amp; 5x Certified Career Coach.</p>' +
